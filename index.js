...
app.get("/cart-total", (req, res) => {
  ...
  res.send("Cart total is " + total.toString());
});
...
app.get("/free-shipping", (req, res) => {
  ...
  res.send("Free shipping eligibility: " + eligible.toString());
});
...
app.get("/membership-discount", (req, res) => {
  ...
  res.send("Final price after membership discount: " + finalPrice.toString());
});
...
app.get("/calculate-tax", (req, res) => {
  ...
  res.send("Tax on cart total is: " + tax.toString());
});
...
app.get("/estimate-delivery", (req, res) => {
  ...
  res.send("Estimated delivery time is: " + deliveryTime + " days");
});
...
app.get("/discounted-price", (req, res) => {
  ...
  res.send("Discounted price is: " + finalPrice.toString());
});
...
app.get("/shipping-cost", (req, res) => {
  ...
  res.send("Shipping cost is: " + shippingCost.toString());
});
...
app.get("/loyalty-points", (req, res) => {
  ...
  res.send("Loyalty points earned: " + points.toString());
});
